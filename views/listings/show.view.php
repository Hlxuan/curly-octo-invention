        ...
        <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4">
                ...
                <li class="mb-2">
                    ...
                    <span class="text-xs bg-blue-500 text-white rounded-full px-2 py-1 ml-2">校内</span>
                </li>
                <li class="mb-2">
                    <strong>标签:</strong> <?= $listing->tags ?></span>
                </li>
            </ul>
        </div>
    </div>
